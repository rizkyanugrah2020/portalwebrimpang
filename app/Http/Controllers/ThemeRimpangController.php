...
class ThemeRimpangController extends Controller
{
    ...
    public function berita()
    {
        ...
        $hubungi = $this->hubungi;
        $sosialMedia = $this->sosialMedia;
        $berita = $organisasi->event()->where('jenis', 'berita')->orWhere('jenis', 'artikel')->orderBy('created_at', 'desc')->paginate(6);
    ...
    public function agenda()
    {
        ...
        $hubungi = $this->hubungi;
        $sosialMedia = $this->sosialMedia;
        $agenda = $organisasi->event()->where('jenis', 'agenda')->orderBy('created_at', 'desc')->paginate(6);
